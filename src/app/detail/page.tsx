        ...
        if (!doubanDataFetched && doubanId) {
          ...
          if (wmdbData && wmdbData.data && wmdbData.data.length > 0) {
            ...
            videoDetailToSet = {
              ...
              year: wmdbData.year || year || '', // 优先使用WMDB年份，然后是现有年份
              ...
              class: movieData.genre
                ...
                : initialClass || '', // WMDB类型，然后是现有类别
              desc: movieData.description || initialDesc || '', // WMDB描述，然后是现有描述
              country: movieData.country || '', // WMDB国家
